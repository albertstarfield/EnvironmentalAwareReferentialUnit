...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_exec" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#001aca3d#;
   pragma Export (C, u00001, "test_execB");
   ...
   u00078 : constant Version_32 := 16#4259a79c#;
   pragma Export (C, u00078, "ada__strings__unboundedB");
   u00079 : constant Version_32 := 16#b40332b4#;
   pragma Export (C, u00079, "ada__strings__unboundedS");
   u00080 : constant Version_32 := 16#ef3c5c6f#;
   pragma Export (C, u00080, "system__finalization_primitivesB");
   u00081 : constant Version_32 := 16#f622319e#;
   pragma Export (C, u00081, "system__finalization_primitivesS");
   u00082 : constant Version_32 := 16#9cd38c2c#;
   pragma Export (C, u00082, "system__os_locksS");
   u00083 : constant Version_32 := 16#401f6fd6#;
   pragma Export (C, u00083, "interfaces__cB");
   u00084 : constant Version_32 := 16#3dbcc8ee#;
   pragma Export (C, u00084, "interfaces__cS");
   u00085 : constant Version_32 := 16#8f29e754#;
   pragma Export (C, u00085, "system__os_constantsS");
   u00086 : constant Version_32 := 16#05222263#;
   pragma Export (C, u00086, "system__put_imagesB");
   u00087 : constant Version_32 := 16#6cd85c4b#;
   pragma Export (C, u00087, "system__put_imagesS");
   u00088 : constant Version_32 := 16#22b9eb9f#;
   pragma Export (C, u00088, "ada__strings__text_buffers__utilsB");
   u00089 : constant Version_32 := 16#89062ac3#;
   pragma Export (C, u00089, "ada__strings__text_buffers__utilsS");
   u00090 : constant Version_32 := 16#b3c38977#;
   pragma Export (C, u00090, "system__return_stackS");
   u00091 : constant Version_32 := 16#c34b231e#;
   pragma Export (C, u00091, "ada__finalizationS");
   u00092 : constant Version_32 := 16#b228eb1e#;
   pragma Export (C, u00092, "ada__streamsB");
   u00093 : constant Version_32 := 16#613fe11c#;
   pragma Export (C, u00093, "ada__streamsS");
   u00094 : constant Version_32 := 16#367911c4#;
   ...
   u00100 : constant Version_32 := 16#bd85f768#;
   pragma Export (C, u00100, "system__bit_opsS");
   u00101 : constant Version_32 := 16#5b4659fa#;
   pragma Export (C, u00101, "ada__charactersS");
   u00102 : constant Version_32 := 16#cde9ea2d#;
   pragma Export (C, u00102, "ada__characters__latin_1S");
   u00103 : constant Version_32 := 16#d053aba9#;
   pragma Export (C, u00103, "ada__strings__searchB");
   u00104 : constant Version_32 := 16#97fe4a15#;
   pragma Export (C, u00104, "ada__strings__searchS");
   u00105 : constant Version_32 := 16#52627794#;
   pragma Export (C, u00105, "system__atomic_countersB");
   u00106 : constant Version_32 := 16#ac6eb497#;
   pragma Export (C, u00106, "system__atomic_countersS");
   u00107 : constant Version_32 := 16#553a519e#;
   pragma Export (C, u00107, "system__atomic_primitivesB");
   u00108 : constant Version_32 := 16#78a6d0b7#;
   pragma Export (C, u00108, "system__atomic_primitivesS");
   u00109 : constant Version_32 := 16#756a1fdd#;
   pragma Export (C, u00109, "system__stream_attributesB");
   u00110 : constant Version_32 := 16#cc7d5f1e#;
   pragma Export (C, u00110, "system__stream_attributesS");
   u00111 : constant Version_32 := 16#1c617d0b#;
   pragma Export (C, u00111, "system__stream_attributes__xdrB");
   u00112 : constant Version_32 := 16#e4218e58#;
   pragma Export (C, u00112, "system__stream_attributes__xdrS");
   u00113 : constant Version_32 := 16#b3448438#;
   pragma Export (C, u00113, "system__fat_fltS");
   u00114 : constant Version_32 := 16#95768d35#;
   pragma Export (C, u00114, "system__fat_lfltS");
   u00115 : constant Version_32 := 16#efa623df#;
   pragma Export (C, u00115, "system__fat_llfS");
   u00116 : constant Version_32 := 16#27ac21ac#;
   pragma Export (C, u00116, "ada__text_ioB");
   u00117 : constant Version_32 := 16#60f53344#;
   pragma Export (C, u00117, "ada__text_ioS");
   u00118 : constant Version_32 := 16#1cacf006#;
   pragma Export (C, u00118, "interfaces__c_streamsB");
   u00119 : constant Version_32 := 16#d07279c2#;
   pragma Export (C, u00119, "interfaces__c_streamsS");
   u00120 : constant Version_32 := 16#fb523cdb#;
   pragma Export (C, u00120, "system__crtlS");
   u00121 : constant Version_32 := 16#ec2f4d1e#;
   pragma Export (C, u00121, "system__file_ioB");
   u00122 : constant Version_32 := 16#16390e12#;
   pragma Export (C, u00122, "system__file_ioS");
   u00123 : constant Version_32 := 16#c04dcb27#;
   pragma Export (C, u00123, "system__os_libB");
   u00124 : constant Version_32 := 16#f51dc4c4#;
   pragma Export (C, u00124, "system__os_libS");
   u00125 : constant Version_32 := 16#94d23d25#;
   pragma Export (C, u00125, "system__atomic_operations__test_and_setB");
   u00126 : constant Version_32 := 16#57acee8e#;
   pragma Export (C, u00126, "system__atomic_operations__test_and_setS");
   u00127 : constant Version_32 := 16#b7152171#;
   pragma Export (C, u00127, "system__atomic_operationsS");
   u00128 : constant Version_32 := 16#256dbbe5#;
   pragma Export (C, u00128, "system__stringsB");
   u00129 : constant Version_32 := 16#ebf45b4c#;
   pragma Export (C, u00129, "system__stringsS");
   u00130 : constant Version_32 := 16#fa03c63e#;
   ...
   u00132 : constant Version_32 := 16#c58d28a3#;
   pragma Export (C, u00132, "system__concat_2S");
   u00133 : constant Version_32 := 16#bcc987d2#;
   pragma Export (C, u00133, "system__concat_4B");
   u00134 : constant Version_32 := 16#438e046a#;
   pragma Export (C, u00134, "system__concat_4S");
   u00135 : constant Version_32 := 16#7f4ba8ed#;
   pragma Export (C, u00135, "system__img_fltS");
   u00136 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00136, "system__float_controlB");
   u00137 : constant Version_32 := 16#908a1868#;
   pragma Export (C, u00137, "system__float_controlS");
   u00138 : constant Version_32 := 16#19ff6eea#;
   pragma Export (C, u00138, "system__img_unsS");
   u00139 : constant Version_32 := 16#1efd3382#;
   pragma Export (C, u00139, "system__img_utilB");
   u00140 : constant Version_32 := 16#076fffed#;
   pragma Export (C, u00140, "system__img_utilS");
   u00141 : constant Version_32 := 16#d56ce2ec#;
   pragma Export (C, u00141, "system__powten_fltS");
   u00142 : constant Version_32 := 16#a7e38293#;
   pragma Export (C, u00142, "system__val_fltS");
   u00143 : constant Version_32 := 16#d56674ad#;
   pragma Export (C, u00143, "system__exn_fltS");
   u00144 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00144, "system__memoryB");
   u00145 : constant Version_32 := 16#68e2c74e#;
