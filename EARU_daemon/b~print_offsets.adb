pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~print_offsets.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~print_offsets.adb");
...
package body ada_main is
   ...
   E113 : Short_Integer; pragma Import (Ada, E113, "earu__shm_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_print_offsets");
