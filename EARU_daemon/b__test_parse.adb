pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__test_parse.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__test_parse.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_test_parse");
...
--  BEGIN Object file/option list
   --   /usr/local/EnvironmentalAwareReferentialUnit/EARU_daemon/test_parse.o
   --   -L/usr/local/EnvironmentalAwareReferentialUnit/EARU_daemon/
   --   -L/usr/local/EnvironmentalAwareReferentialUnit/EARU_daemon/
