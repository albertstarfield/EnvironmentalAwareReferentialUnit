pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~test_time.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~test_time.adb");
...
package body ada_main is
   ...
   E089 : Short_Integer; pragma Import (Ada, E089, "ada__strings__utf_encoding_E");
   ...
   E086 : Short_Integer; pragma Import (Ada, E086, "ada__strings__text_buffers_E");
   ...
   E074 : Short_Integer; pragma Import (Ada, E074, "ada__calendar__time_zones_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_test_time");
