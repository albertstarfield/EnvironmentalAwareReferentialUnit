...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_time" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#82ffc9c1#;
   pragma Export (C, u00001, "test_timeB");
   ...
   u00071 : constant Version_32 := 16#c1ef1512#;
   pragma Export (C, u00071, "ada__calendar__formattingB");
   u00072 : constant Version_32 := 16#5a9d5c4e#;
   pragma Export (C, u00072, "ada__calendar__formattingS");
   u00073 : constant Version_32 := 16#974d849e#;
   pragma Export (C, u00073, "ada__calendar__time_zonesB");
   u00074 : constant Version_32 := 16#55da5b9f#;
   pragma Export (C, u00074, "ada__calendar__time_zonesS");
   u00075 : constant Version_32 := 16#6e143a7e#;
   pragma Export (C, u00075, "system__val_fixed_64S");
   u00076 : constant Version_32 := 16#afdc38b2#;
   pragma Export (C, u00076, "system__arith_64B");
   u00077 : constant Version_32 := 16#34c19b86#;
   pragma Export (C, u00077, "system__arith_64S");
   ...
   u00083 : constant Version_32 := 16#ce5f50f9#;
   pragma Export (C, u00083, "system__val_intS");
   u00084 : constant Version_32 := 16#39f8db91#;
   pragma Export (C, u00084, "system__val_unsS");
   u00085 : constant Version_32 := 16#a201b8c5#;
   pragma Export (C, u00085, "ada__strings__text_buffersB");
   u00086 : constant Version_32 := 16#a7cfd09b#;
   pragma Export (C, u00086, "ada__strings__text_buffersS");
   u00087 : constant Version_32 := 16#e6d4fa36#;
   pragma Export (C, u00087, "ada__stringsS");
   u00088 : constant Version_32 := 16#8b7604c4#;
   pragma Export (C, u00088, "ada__strings__utf_encodingB");
   u00089 : constant Version_32 := 16#c9e86997#;
   pragma Export (C, u00089, "ada__strings__utf_encodingS");
   u00090 : constant Version_32 := 16#bb780f45#;
   pragma Export (C, u00090, "ada__strings__utf_encoding__stringsB");
   u00091 : constant Version_32 := 16#b85ff4b6#;
   pragma Export (C, u00091, "ada__strings__utf_encoding__stringsS");
   u00092 : constant Version_32 := 16#d1d1ed0b#;
   pragma Export (C, u00092, "ada__strings__utf_encoding__wide_stringsB");
   u00093 : constant Version_32 := 16#5678478f#;
   pragma Export (C, u00093, "ada__strings__utf_encoding__wide_stringsS");
   u00094 : constant Version_32 := 16#c2b98963#;
   pragma Export (C, u00094, "ada__strings__utf_encoding__wide_wide_stringsB");
   u00095 : constant Version_32 := 16#d7af3358#;
   pragma Export (C, u00095, "ada__strings__utf_encoding__wide_wide_stringsS");
   u00096 : constant Version_32 := 16#683e3bb7#;
   pragma Export (C, u00096, "ada__tagsB");
   u00097 : constant Version_32 := 16#4ff764f3#;
   pragma Export (C, u00097, "ada__tagsS");
   u00098 : constant Version_32 := 16#3548d972#;
   pragma Export (C, u00098, "system__htableB");
   u00099 : constant Version_32 := 16#f1af03bf#;
   pragma Export (C, u00099, "system__htableS");
   u00100 : constant Version_32 := 16#1f1abe38#;
   pragma Export (C, u00100, "system__string_hashB");
   u00101 : constant Version_32 := 16#56ea83c0#;
   pragma Export (C, u00101, "system__string_hashS");
   u00102 : constant Version_32 := 16#e7d0da5b#;
   pragma Export (C, u00102, "system__val_lluS");
   u00103 : constant Version_32 := 16#27ac21ac#;
   pragma Export (C, u00103, "ada__text_ioB");
   u00104 : constant Version_32 := 16#60f53344#;
   pragma Export (C, u00104, "ada__text_ioS");
   u00105 : constant Version_32 := 16#b228eb1e#;
   pragma Export (C, u00105, "ada__streamsB");
   u00106 : constant Version_32 := 16#613fe11c#;
   pragma Export (C, u00106, "ada__streamsS");
   u00107 : constant Version_32 := 16#367911c4#;
   pragma Export (C, u00107, "ada__io_exceptionsS");
   u00108 : constant Version_32 := 16#05222263#;
   pragma Export (C, u00108, "system__put_imagesB");
   u00109 : constant Version_32 := 16#6cd85c4b#;
   pragma Export (C, u00109, "system__put_imagesS");
   u00110 : constant Version_32 := 16#22b9eb9f#;
   pragma Export (C, u00110, "ada__strings__text_buffers__utilsB");
   u00111 : constant Version_32 := 16#89062ac3#;
   pragma Export (C, u00111, "ada__strings__text_buffers__utilsS");
   u00112 : constant Version_32 := 16#1cacf006#;
   pragma Export (C, u00112, "interfaces__c_streamsB");
   u00113 : constant Version_32 := 16#d07279c2#;
   pragma Export (C, u00113, "interfaces__c_streamsS");
   u00114 : constant Version_32 := 16#ec2f4d1e#;
   pragma Export (C, u00114, "system__file_ioB");
   u00115 : constant Version_32 := 16#16390e12#;
   pragma Export (C, u00115, "system__file_ioS");
   u00116 : constant Version_32 := 16#c34b231e#;
   pragma Export (C, u00116, "ada__finalizationS");
   u00117 : constant Version_32 := 16#d00f339c#;
   pragma Export (C, u00117, "system__finalization_rootB");
   u00118 : constant Version_32 := 16#7a0a6580#;
   pragma Export (C, u00118, "system__finalization_rootS");
   u00119 : constant Version_32 := 16#ef3c5c6f#;
   pragma Export (C, u00119, "system__finalization_primitivesB");
   u00120 : constant Version_32 := 16#f622319e#;
   pragma Export (C, u00120, "system__finalization_primitivesS");
   u00121 : constant Version_32 := 16#9cd38c2c#;
   pragma Export (C, u00121, "system__os_locksS");
   u00122 : constant Version_32 := 16#8f29e754#;
   pragma Export (C, u00122, "system__os_constantsS");
   u00123 : constant Version_32 := 16#fa03c63e#;
   ...
   u00125 : constant Version_32 := 16#c58d28a3#;
   pragma Export (C, u00125, "system__concat_2S");
   u00126 : constant Version_32 := 16#edeb270c#;
   pragma Export (C, u00126, "system__img_fixed_64S");
   u00127 : constant Version_32 := 16#0e459105#;
   pragma Export (C, u00127, "system__exn_lliS");
   u00128 : constant Version_32 := 16#1efd3382#;
   pragma Export (C, u00128, "system__img_utilB");
   u00129 : constant Version_32 := 16#076fffed#;
   pragma Export (C, u00129, "system__img_utilS");
   u00130 : constant Version_32 := 16#19ff6eea#;
   pragma Export (C, u00130, "system__img_unsS");
   u00131 : constant Version_32 := 16#0ddbd91f#;
   pragma Export (C, u00131, "system__memoryB");
   u00132 : constant Version_32 := 16#68e2c74e#;
