pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~test_sensor.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~test_sensor.adb");
...
package body ada_main is
   ...
   E158 : Short_Integer; pragma Import (Ada, E158, "gnat__secure_hashes__sha2_32_E");
   E154 : Short_Integer; pragma Import (Ada, E154, "gnat__sha256_E");
   ...
   E148 : Short_Integer; pragma Import (Ada, E148, "earu__shm_E");
   E113 : Short_Integer; pragma Import (Ada, E113, "earu__io_E");
   ...
   begin
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "gnat__sha256__finalize_spec");
      begin
         F2;
      end;
      E079 := E079 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_test_sensor");
